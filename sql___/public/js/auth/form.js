...
var emailTxt = document.querySelector('.email')  // Txt는 div
...
function verifyEmail() {
	...
	if(email === '') {
		...
		// http://127.0.0.1:3001/api/auth/verify?email=userid&value=dlstn7609@hanmail.net
		.then(function(r) {
			console.log(r)
			if(r.data.isUsed) {
