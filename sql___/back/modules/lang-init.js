      ...
      return {
        ERROR: {
          ...
          JOIN: {
            ...
            PW2_LEN:
              "Re-entering the password must be between 6 and 24 characters",
            ...
            EMAIL_TAKEN:
              "This is the email you are using. Please use a different email",
        ...
        ALERT: {
          ...
          SNS_MSG:
            "If you log in again after withdrawing from SNS, you can rejoin.",
        },
        GLOBAL: {
